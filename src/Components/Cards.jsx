...
const Cards = (props) => {
    ...
    return (
    <div key={id} className={"boxStyle"} > {/* This onClick to create synchronize onClick with its' parent component*/}
    <div onClick={onClick}>
        <div>
        ...
        props.editEnabled ? 
        <>
        <Button color={'success'} name={'Edit'} linkButton={true} link={`/blogs/edit/${link}`}/>
        </>:
        <>
        </>}
    </div>
